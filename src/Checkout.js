        ...
        <ul class="cards">
          <li class="cards_item">
            ...
            <div class="card_content">
              ...
              <div class="card_text">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent blandit nunc id risus ultrices, at pharetra nulla cursus. Aliquam at accumsan magna, at tincidunt magna.</p>
                <hr />
              </div>
            </div>
            </div>
        ...
        <div class="box-1 bg-light user">
            <div class="box-inner-1 pb-3 mb-3 ">
                <div class="d-flex justify-content-between mb-3 userdetails">
                    <p class="fw-bold">Enjoy your Show!x</p>
                        ...
                        <div class="address">
                            ...
                            <div class=" my-3">
                                ...
                                <div class="inputWithcheck">
                                    <input class="form-control" type="text" value="MOVIETIME"/>
                            ...
                            <div class="d-flex flex-column dis">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <p><span class="fas fa-dollar-sign"></span>{discount}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <p class="fw-bold">Total</p>
                                    <p class="fw-bold"><span class="fas fa-dollar-sign"></span>{total}</p>
                                </div>
                                <div class="btn btn-primary mt-2">Make Payment</div>
                            </div>
                        </div>
                    </div>
                </form>
